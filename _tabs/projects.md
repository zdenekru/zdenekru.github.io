...
A small personal **homelab server** built around the Intel N100 platform.  
Used for experimenting with **self-hosted services, monitoring, and infrastructure automation**.
